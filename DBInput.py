...
def ship_status_update(ship_id,name,ship_class,energy,power,resourceA,resourceB,resourceA_income,resourceB_income):
    ship_id=ship_id
    ship_name=name
    ship_class=ship_class
    ship_energy=energy
    ...
    ship_resourceA=resourceA
    ship_resourceB=resourceB
    ship_resourceA_income=resourceA_income
    ship_resourceB_income=resourceB_income
    ...
    table.update_item(
        ...
        UpdateExpression='SET ship_energy= :energy,ship_power= :power,ship_resourceA= :resourceA, ship_resourceB= :resourceB,ship_resourceA_income= :resourceA_income,ship_resourceB_income= :resourceB_income',
        ExpressionAttributeValues={
            ':energy': ship_energy,
            ':power': ship_power,
            ':resourceA': ship_resourceA,
            ':resourceB': ship_resourceB,
            ':resourceA_income': ship_resourceA_income,
            ':resourceB_income': ship_resourceB_income
        }
    )
