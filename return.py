...
ship_status_update(ship_a.shipname,ship_a.shipclass,ship_a.energy,ship_a.power,ship_a.resourceA,ship_a.resourceB,)
avaliable_module_list=module_list(ship_a.shipname)
selection=input("Type in Module Name you want to build:\n")
build_module(selection,ship_a.shipname)
